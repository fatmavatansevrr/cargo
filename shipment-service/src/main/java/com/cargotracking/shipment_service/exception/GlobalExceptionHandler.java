...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleTrackingNumberAlreadyExistsException(TrackingNumberAlreadyExistsException ex) {
        log.error("Tracking number already exists: {}", ex.getMessage());
        ErrorResponse errorResponse = ErrorResponse.builder()
                .timestamp(LocalDateTime.now())
