            ...
            if (selectedRole === 'CARRIER') {
                ...
                try {
                    ...
                    if (response.success) {
                        ...
                        setError('Kargo şirketleri yüklenemedi.');
                    }
                } catch (err) {
                        ...
                        {selectedRole === 'CARRIER' && (
                            <div className="animate-slide-down mb-6">
                                ...
                                <div className="mt-2 relative">
                                    <select
                                        id="companyId"
                                        {...register('companyId', { required: 'Kargo şirketi seçimi zorunludur' })}
                                        className={`appearance-none block w-full bg-white border border-gray-300 rounded-xl py-2 pl-3 pr-10 text-sm shadow-sm focus:outline-none focus:ring-1 focus:ring-purple-500 focus:border-purple-500 transition duration-150 ease-in-out ${
                                            ...
                                            <>
                                                ...
                                                {companies.map((company) => (
                                                    <option key={company.id} value={company.id}>
                                                        {company.firstName} {/* Şirketler de User modeli kullandığı için firstName */}
                                                    </option>
                                                ))}
                                            </>
                                        )}
